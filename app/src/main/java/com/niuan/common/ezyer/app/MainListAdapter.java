...
public class MainListAdapter extends EzyerListHolderAdapter<EzyerViewHolder, NetStruct.Data> {
    ...
    @Override
    public Class<EzyerViewHolder> getHolderType(int position) {
        return getSupportHolderTypes()[0];
    }
    ...
    public EzyerDataViewIdPair initDataViewIdPair() {
        EzyerDataViewIdPair listHolderPair1 = new EzyerDataViewIdPair() {{
