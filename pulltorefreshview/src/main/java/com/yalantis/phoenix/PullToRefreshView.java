...
public class PullToRefreshView extends ViewGroup {
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.RefreshView_type, -1);
        a.recycle();
...
//                throw new InvalidParameterException("Type does not exist");
    ...
    public boolean onTouchEvent(@NonNull MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                setPercent(mCurrentDragPercent, true);
    ...
    private final Animation mAnimateToCorrectPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            setPercent(mCurrentDragPercent, false);
    ...
    private void setPercent(float percent, boolean invalidate) {
        ...
        if (mBaseRefreshView != null) {
            mBaseRefreshView.setPercent(percent, invalidate);
        }
